...
func baueLevel7() EinzelLevel {
	...
	sk.BauteilEinfuegen(5,200,250,b.NOT)	
	sk.BauteilEinfuegen(6,350,200,b.OR)	
	sk.BauteilEinfuegen(7,500,200,b.NOT)	
	sk.BauteilEinfuegen(8,350,450,b.AND)	
	sk.BauteilEinfuegen(9,600,350,b.OR)	
	
	// --------------   Lampen einfügen   -------------------------//
	sk.BauteilEinfuegen(10,700,350,b.Lampe)

	// --------------   Leitungen einfügen   ----------------------//
	sk.VerbindungEinfuegen(1,6,1,200)
	sk.VerbindungEinfuegen(2,5,1,150)
	sk.VerbindungEinfuegen(5,6,2,270)
