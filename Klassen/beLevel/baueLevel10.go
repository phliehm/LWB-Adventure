...
func baueLevel10() EinzelLevel {
	...
	elevel.minSchalter	= 5					// maximale Anzahl von Schaltungen,
	...
	elevel.text = append(elevel.text,"Zeigen Sie, was Sie")
	elevel.text = append(elevel.text,"können!")
...
//	sk.BauteilEinfuegen(17,150,550,b.NOT)
	...
	sk.BauteilEinfuegen(32,350,275,b.NOT)	
	sk.BauteilEinfuegen(34,350,575,b.NOT)	

	// 2. Gatter-Reihe	
	sk.BauteilEinfuegen(41,450,200,b.OR)	
	sk.BauteilEinfuegen(42,450,500,b.OR)	
	
	// 3. NOT-Reihe
	sk.BauteilEinfuegen(51,550,500,b.NOT)	

	// 3. Gatter-Reihe	
	sk.BauteilEinfuegen(61,650,200,b.NOT)	
	sk.BauteilEinfuegen(62,650,350,b.XOR)	
	
	
	
	// --------------   Lampen einfügen   -------------------------//
	sk.BauteilEinfuegen(71,750,200,b.Lampe)
	sk.BauteilEinfuegen(72,750,350,b.Lampe)
//	sk.BauteilEinfuegen(72,750,550,b.Lampe)


	// --------------   Leitungen einfügen   ----------------------//
	// Schalter zu NOT zu Gatter
	sk.VerbindungEinfuegen(1,21,1,125)
	...
	sk.VerbindungEinfuegen(7,24,1,125)
	...
	sk.VerbindungEinfuegen(22,32,2,300)
	sk.VerbindungEinfuegen(32,41,2,400)	
	sk.VerbindungEinfuegen(23,42,1,400)
	sk.VerbindungEinfuegen(24,34,1,300)
	sk.VerbindungEinfuegen(34,42,2,400)
	// Gatter 2 zu NOT zu Gatter 3
	sk.VerbindungEinfuegen(41,61,1,600)
	sk.VerbindungEinfuegen(41,62,1,600)
	sk.VerbindungEinfuegen(42,51,1,500)
	sk.VerbindungEinfuegen(51,62,2,600)
	
	// Gatter 3 zu Lampe 2
	sk.VerbindungEinfuegen(61,71,1,700)
	sk.VerbindungEinfuegen(62,72,1,700)
