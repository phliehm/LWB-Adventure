 ...
 * Datum: 03.03.2015 ; letzte Änderung: 26.04.2021 (Details: siehe gfximpl.go)
...
//       geöffnet. Die Zeichenfarbe ist Schwarz, ohne Transparenz. Der 
//       Ursprung (0,0) ist oben links im Fenster. Die x-Koordinate wächst
//       horizontal nach rechts, die y-Koordinate vertikal nach unten.
...
// Tastaturzeichen (taste, tiefe) rune
...
// Vor.: Das Grafikfenster ist offen.
// Erg.: Anschlagzeit, Abschwellzeit, Haltepegel und Ausklingzeit sind
//       in ms geliefert.
