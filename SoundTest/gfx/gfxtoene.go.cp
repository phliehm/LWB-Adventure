package gfx
// Autor: St. Schmidt
// Datum: 08.05.2019 ; letzter Stand: 26.04.2021
// Zweck: Töne/Noten spielen können

import "math" 

// Konstanten für die Signalform der gespielten Töne
const (            
...
// Vor.: -
//
// Erg.: Geliefert sind: Abtastrate der WAV-Daten in Hz, z.B. 44100,
// Auflösung der Klänge (1: 8 Bit; 2: 16 Bit), die Anzahl der Kanäle (1: mono, 2:stereo),
...
// verzögert. Der voreingestellte Standard ist aus 'GibHuellkurve ()' und 'GibKlangParameter()' ersichtlich.
