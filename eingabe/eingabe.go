...
func klickbarElemente() {
	...
	fabweb1 = vierecke.New(900,265,900,565,1045,265,1045,565)
	wthek1 = vierecke.New(85,265,255,265,255,560,85,560)
	darth2 = vierecke.New(130,405,130,680,280,405,280,680)
	jethi2 = vierecke.New(800,435,785,495,880,500,900,430)
	herk3 = vierecke.New(100,270,70,415,175,385,160,270)
	wthek3 = vierecke.New(560,245,560,495,705,245,705,495)
	darth4 = vierecke.New(205,140,210,490,385,450,385,140)
	amoebi4 = vierecke.New(1040,315,1010,405,1155,405,1080,295)
	wthek4 = vierecke.New(655,195,655,515,845,195,845,515)
