...
func Vaderobi() {
	...
	for i:=1; i<7; i++ {
		...
		gfx.SetzeFont("../../Schriftarten/Starjedi.ttf",38)
		gfx.SchreibeFont(700,5,"Super - ALP - Escape")
		
		//Aufgaben-Text
		gfx.Stiftfarbe(0,0,0)
		//gfx.SetzeFont("../../Schriftarten/ltype.ttf",14)
		gfx.SetzeFont("./terminus-font/TerminusTTF-Bold-4.49.2.ttf",16)
		...
		gfx.SetzeFont("./terminus-font/TerminusTTF-4.49.2.ttf",14)
		...
		//Level
		gfx.Stiftfarbe(0,0,0)
		gfx.SetzeFont("../../Schriftarten/Starjedi.ttf",30)
		gfx.SchreibeFont(695,320,"Level "+fmt.Sprint(i))
		
		//Zähler
		gfx.SetzeFont("./terminus-font/TerminusTTF-Bold-4.49.2.ttf",22)
		...
		for {
			...
			if InLinkerObererEcke() {
				...
				gfx.Stiftfarbe(0,0,0)
				gfx.SetzeFont("../../Schriftarten/Starjedi.ttf",32)
