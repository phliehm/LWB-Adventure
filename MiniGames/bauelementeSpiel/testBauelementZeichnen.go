...
//	var aus b.Anschluss = b.Anschluss{1,false}
	...
	v1.SetzeEingang(1, true)
	fmt.Println("Eingangswerte von Leitung 1", v1.GibEingang(1),v1.GibEingang(2))
	fmt.Println("Ausgangswert von Leitung 1", v1.BerechneAusgang())
